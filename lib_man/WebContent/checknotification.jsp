...
<header id="theader">
      <div id="embded">
      <center><h3 > Add Student in Library managment system</h3><br></center>
    ...
    <label id="id" >Rollno</label>
    <input type="text" id="id" name="rollno" required="required" /><br><br>
    ...
    <input type="text" id="course" name="course" required="required" /><br><br>
    <label id="can_issue" >Books Quota</label>
    <input type="number" id="can_issue" name="books" required="required" /><br><br>
